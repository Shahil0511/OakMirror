    ...
    return (
        <div className="relative w-screen h-screen overflow-hidden flex flex-col md:flex-row">
            ...
            <motion.div
                ...
                className="absolute md:relative top-0 w-full h-[40%] md:w-[70%] md:h-full bg-cover bg-center bg-no-repeat z-0"
            ...
            <motion.div
                ...
                className="absolute top-0 left-0 w-full h-[40%] bg-gradient-to-b from-black/60 to-transparent md:hidden z-10"
            />

            {/* Auth Panel Container - Same structure as Hero */}
            <motion.div
            ...
            >
                <div className="w-full max-w-md">
                    ...
                    <motion.button
                        ...
                        onClick={onBack}
                        className="mb-6 text-slate-900 hover:text-slate-900 transition-colors flex items-center gap-2"
                    >
                    ...
                    {/* Auth Form Content */}
                    <div className="bg-white backdrop-blur-xl border border-slate-200/80 rounded-3xl p-8 shadow-2xl">
                        {/* Logo */}
